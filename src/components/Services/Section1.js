  ...
  return (
    <div className="">
      <div className="max-w-[1300px] lg:w-[95%] w-[90%] m-auto lg:pt-[13rem] pt-[11rem]">
        <div>
          <h1 className="font-redhawk lg:text-[45px] text-[32px] leading-[52px] lg:w-[60%] w-full lg:mb-6 mb-3">
            What we do
          </h1>
          <p className="font-obviously_r lg:text-14 text-[12px] lg:leading-[24px] leading-[20px] mb-[5rem] lg:w-[80%] w-full">
